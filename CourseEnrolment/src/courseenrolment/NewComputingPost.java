...
public class NewComputingPost extends javax.swing.JFrame {

    /**
     * Creates new form NewComputingPost
     */
    Db d = new Db();
    String filename = null;
    byte[] pic = null;
    Student a = new Student();
    public NewComputingPost() {
        initComponents();
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        setTitle("School Of Buisness Computing Intake");
        ...
        jLabel1.setText("New Postgraduate Intake School of Computing");
    ...
    private void inserbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inserbtnActionPerformed
        ...
        boolean x = d.socPostStudent(a);
        boolean y = d.socPostSemOne(a);
        boolean z = d.socPostSemTwo(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewComputingPost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewComputingPost().setVisible(true);
            }
        });
    }
